...
class TeamScore{
  ...
  setElScoreWajib(){
    ...
    temp += `
        ...
        <div class="buttons">
          <div class="total" id="total_wajib_${this.id}">${sum(this.scoreWajib)}</div>
          <div class="button minus" id="minus_wajib_${this.id}" onclick="updateScore(this)">0</div>
  ...
  setElScoreQWC(){
    ...
    temp += `
        ...
        <div class="buttons">
          <div class="total" id="total_wajib_${this.id}">${sum(this.scoreQWC)}</div>
          <div class="button minus" id="minus_qwc_${this.id}" onclick="updateScore(this)">0</div>
  ...
  setElScoreRebutan(){
    ...
    temp += `
        ...
        <div class="buttons">
          <div class="total" id="total_wajib_${this.id}">${sum(this.scoreRebutan)}</div>
